...
The tokens in this document are not applied to the app yet; `src/renderer/src/assets/main.css` still
uses the previous neutral palette. Applying them is a follow-up change.
